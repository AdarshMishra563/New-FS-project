...
SECRET_KEY = 'django-insecure-xryt9333qn@2=d+sop58av#3pf=^_db$ac(=5_6dp#03wnawyi'
...
# If you want to allow only specific frontend domains:
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:5173",
    "http://127.0.0.1:5174",
    "http://your-frontend-domain.com",  # ✅ Replace with your frontend URL if deployed
]
CSRF_TRUSTED_ORIGINS = [
    "http://localhost:5174",  # Same as above
]
